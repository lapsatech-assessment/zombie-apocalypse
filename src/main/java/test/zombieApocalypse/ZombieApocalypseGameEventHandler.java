...
public class ZombieApocalypseGameEventHandler {
    ...
    public static ZombieApocalypseGameEventHandler empty() {
        return new ZombieApocalypseGameEventHandler();
    }

    public static ZombieApocalypseGameEventHandler consoleWriter() {
        return new ConsoleWriterZombieApocalypseGameEventHandler();
    }

    protected ZombieApocalypseGameEventHandler() {
    }
    ...
    private final static class ConsoleWriterZombieApocalypseGameEventHandler extends ZombieApocalypseGameEventHandler {
        ...
        public void zombieFinishedMovement(Position finalZombiePosition, int zombieId) {
            System.out
                    .println(String.format("Zombie %s has finished its movement at %s", zombieId, finalZombiePosition));
        }
        ...
        public void gameFinished(int zombiesScore, Stream<Position> zombies, Stream<Position> survivedCreatures) {
            ...
            System.out.println(
                    String.format("Creatures survived at positions: %s", positionsAsString(survivedCreatures)));
